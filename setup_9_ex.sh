...
docker run -d --network=host --name=9hits 9hitste/app /nh.sh --token=7bb1440ac55eeb5221d7d68c87d33406 --system-session --ex-proxy-sessions=5 --allow-crypto=no --session-note=$systemID --note=$systemID --hide-browser --cache-del=0 --ex-proxy-url=http://proxy.9hits.com/pool/d745f1b671dd2046277592ca1b397592
